...
apple_labelled = pd.read_csv('../DATA/Apple_Processed.csv')

apple_labelled = apple_labelled[apple_labelled.text.notnull()]

y = apple_labelled['label'].values
# project_data.drop(['label'], axis=1, inplace=True)
print(apple_labelled.head(5))
X = apple_labelled.text.values
...
import pickle
outfile = open('vectorizer_apple','wb')
...
def logisticRegression():
    ...
    filename = 'Logistic_Regression_Apple.sav'
...
def naiveBayes():
    ...
    filename = 'Naive_Bayes_Apple.sav'
